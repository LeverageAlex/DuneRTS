...
% 1: Titel, 2: Beschreibung, 3: Begründung, 4: Abhängigkeit, 5: Priorität, 6: Akteur, 7: Labelname
\newcounter{requirement}
\newenvironment{requirement}[7]
    {
...
In unserem Projekt geht es darum, ein funktionierendes Spiel gemäß Vorgaben aus einem Lastenheft zu erstellen, welches den Namen \textit{Deserts of Dune} tragen wird. Das Spiel ist für zwei Personen gedacht, wobei mehrere Personen dem Spielgeschen als Zuschauer folgen können. Hierbei wird alles, also sowohl die gesamte Spiellogik, als auch die graphische Gestaltung von uns selbst entwickelt und implementiert werden.
