...
namespace GameData.network.messages
{
    ...
    {
        private MapChangeReasons mapChangeReason;
        ...
        public MapChangeMessage(MapChangeReasons reason, MapField[][] newMap, Position stormEye) : base("v1", MessageType.MAP_CHANGE)
        {
