...
namespace GameData.network.util.world.mapField
{
    ...
    public class Mountain : MapField
    {
        ...
        public Mountain(bool hasSpice, bool isInSandstorm, Position stormEye) : base(enums.TileType.MOUNTAINS, enums.Elevation.high, hasSpice, isInSandstorm, false, stormEye)
        {
