...
namespace GameData.network.util.world.mapField
{
    ...
    public class RockPlateau : MapField
    {
        ...
        public RockPlateau(bool hasSpice, bool isInSandstorm, Position stormEye) : base(enums.TileType.PLATEAU, enums.Elevation.low, hasSpice, isInSandstorm, true, stormEye)
        {
