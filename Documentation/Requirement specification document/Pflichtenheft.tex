...
\begin{tabularx}{16cm}{l|X}
	...
	Abhandlung der Runden & \mfaref{FA-Aktion-Spiceblow}, \mfaref{FA-Runden und Züge} \\ 
...
%ToDo: alle Aktivitäts- und Sequenzdiagramme gemäß der Reihenfolge von den Anwendungsfällen aus der Tabelle oben

\includegraphics[width=\textwidth]{images/SQ_Spielfeld}
\captionof{figure}{Sequenzdiagramm für die Spielfeld und -zustands Anzeige \textsc{DUNE}}
%\label{fig:use-case-gameflow}
\includegraphics[width=\textwidth]{images/SQ_Hauswahl}
\captionof{figure}{Sequenzdiagramm für die Häuserwahl in \textsc{DUNE}}
