...
Der \glqq Hauptmenü\grqq -Dialog wird beim Starten der Anwendung zu Beginn angezeigt.}
...
Im \glqq{}Spielmenü\grqq{}-Dialog hat der Benutzer im Benutzer-Client die Möglichkeit, die Partie entweder zu pausieren oder die Partie zu verlassen. Dafür gibt es zwei unterschiedliche Buttons. Dabei gibt es jedoch einen Unterschied, ob das Spielmenü von einem Zuschauer oder einem Spieler aufgerufen wird. Denn wenn der Zuschauer die Partie pausiert, dann läuft die Partie im Hintergrund weiter und der Zuschauer schaut einfach nicht zu. Wenn der Spieler die Partie pausieren will, dann wird der Antrag vom Server geprüft und die Partie gegebenenfalls angehalten. Zudem kann der Benutzer das Menü wieder schließen (Kreuz). 
}
