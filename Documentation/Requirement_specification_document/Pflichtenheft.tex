...
\subsection{Geteilte-Logik}

\includegraphics[width=0.95\textwidth]{images/KlassendiagrammWelt&Charaktere}
\label{fig:Geteilte-Logik-Klassendiagramm}
\captionof{figure}{Klassendiagramm über Welt und Charaktere.}

\subsection{Nutzer-Klient}

\includegraphics[width=0.95\textwidth]{images/KlassendiagrammUserClient}
\label{fig:Geteilte-Logik-Klassendiagramm}
\captionof{figure}{Klassendiagramm über Nutzer-Klient.}

\subsection{Statistik}
\begin{center}

\includegraphics[width=0.5\textwidth]{images/KlassendiagrammStatistik}
\label{fig:Geteilte-Logik-Klassendiagramm}
\captionof{figure}{Klassendiagramm über Statistik.}
...
\begin{center}
\includegraphics[width=0.95\textwidth]{images/classdiagram_configuration}
\label{fig:Konfiguration-Klassendiagramm}
\captionof{figure}{Übersicht über die Klassen, die für die Konfiguration von Partie und Szenario nötig sind.}
\end{center}

\subsubsection{Runden-Handler}

\begin{center}
\includegraphics[width=0.95\textwidth]{images/Meilenstein6_RundenHandler}
\label{fig:Runden-Handler-Klassendiagramm}
\captionof{figure}{Übersicht über die Klassen, die für den korrekten Ablauf der einzelnen Runden zuständig sind. Während das Spiel läuft, also die Runden abgespielt werden, soll das Spiel pausiert werden können.}
\end{center}
...
Klassendiagrammen zu erkennen. Dabei wird für die wichtigen Klassen jedes Diagramms aufgelistet, welche Anforderungen es abdeckt:
\begin{tabularx}{\linewidth}{l|X}
